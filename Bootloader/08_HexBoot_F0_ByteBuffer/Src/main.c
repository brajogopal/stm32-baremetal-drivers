...
int main() {
	...
	*/
	...
	flash_status = firmware_receive_8bit(TEST_STORAGE_ADDR, firmware_buffer, payload_length_bytes, UART_TIMEOUT_LONG);
	...
	flash_status = store_data_in_flash(TEST_STORAGE_ADDR,  (uint16_t*)firmware_buffer, halfword_count);
